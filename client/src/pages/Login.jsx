  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        ...
        (err.message === 'Network Error' ? 'Unable to connect to the server. Please check your internet.' : 'Login failed')
      );
    } finally {
      setLoading(false);
    }
    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <div className="auth-branding">
          ...
          <h2 className="auth-brand-name">TaskFlow</h2>
          <p className="auth-brand-tagline">
            Organize, collaborate, and deliver — all in one place.
          </p>
        ...
        <div className="auth-form-section">
          ...
          <div className="social-buttons">
            ...
            <button type="button" className="social-btn">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="#1C1C1F">
